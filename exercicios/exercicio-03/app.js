/*
01 - No index.html deste diretório (exercício-03):
...
const NUMERO_DE_ITENS = brazilianFoods.length
const NOME_DO_ITEM_1 = brazilianFoods[0]
const NOME_DO_ITEM_2 = brazilianFoods[1]
const NOME_DO_ITEM_3 = brazilianFoods[2]

// const foodsInfo = `
//   Até aqui, o array "brazilianFoods" possui ${NUMERO_DE_ITENS} itens: ${NOME_DO_ITEM_1}, ${NOME_DO_ITEM_2}, ${NOME_DO_ITEM_3}.
// `
const foodsInfo = `
  Até aqui, o array "brazilianFoods" possui ${brazilianFoods.length} itens: ${brazilianFoods[0]}, ${brazilianFoods[1]}, ${brazilianFoods[2]}.
`
...
const maleDogName = ['Chico', 'Zeca']

const femaleDogName = ['Lilica', 'Matilda']

let dogName = maleDogName.concat(femaleDogName)
...
// console.log(dogName[dogName.length -1])
...
const initials = `'${dogName[0][0]}${dogName[1][0]}${dogName[2][0]}${dogName[3][0]}'`
...
const dessert = `'
  ${dogName[0].slice(3)}${dogName[1].slice(2)}${dogName[3].slice(2)}'
`.replace('n', 'd')
